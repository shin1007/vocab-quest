...
英単語を学ぶ単語アプリのプロトタイプです。単語はジャンルで分けず、**英検5級〜1級のレベル別コース**に分けて出題します。
各級の単語の8割が定着すると「英検○級レベルクリア」になり、ホームに次の級までの残り語数が出ます（級は英検の出題レベルを目安にした割り当てで、公式の級別単語リストではありません）。
...
| [`docs/WORD_LIST.md`](docs/WORD_LIST.md) | 単語リスト（285語・類義語666語・語根47種）— 語源・類義語つき、人が読む用 |
